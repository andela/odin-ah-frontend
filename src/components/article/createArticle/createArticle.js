...
import {
  createArticleRequest, openPublishModal, closePublishModal, showCreateError, hideCreateError
...
export class CreateArticle extends Component {
  ...
  finish = async () => {
    const { publishArticle, history } = this.props;
    const {
      ...
      <div>
        ...
        <section className={classnames('section', { 'show-butter': errorMessage || responseMessage })}>
          <div className="butter__container">
            <div className="butter__container--type">
